...
def load_models():
    ...
    # BERT model + tokenizer — loaded directly from HuggingFace model repo
...
if analyze_clicked:
    if not user_text.strip():
        ...
        # Build a simple highlighted-text view
